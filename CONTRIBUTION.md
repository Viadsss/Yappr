...
1. **Clone the repository** directly into the current directory:
...
1. **Switch to the main development branch (`dev`)**:
...
#### 3. Create a new branch based on the latest `dev`:
...
#### 5. Start working on your local copy by adding/editing/removing files.

#### 6. After making changes, commit and push to the repository:
...
-   Ensure the PR follows this structure: `base: dev <- compare: yourname-taskdesc`.
